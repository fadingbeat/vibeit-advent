...
Live Demo: (You can insert your deployed Vercel URL here, e.g., https://xmass.vibeit.hr)
...
Initialize Git: Create a new local repository containing only the index.html file.

Push to GitHub/GitLab: Push the repository to your chosen Git provider.
...
const adventData = [
{ day: 1, title: "Next.js", icon: "fa-brands fa-react", url: "[https://nextjs.org](https://nextjs.org)", desc: "The React Framework" },
{ day: 2, title: "Tailwind", icon: "fa-brands fa-css3-alt", url: "[https://tailwindcss.com](https://tailwindcss.com)", desc: "Utility-first CSS" },
